...
public async Task<String> MakeRequest(string submittedPhoto)
{
    ...
    // Add request headers
    client.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", "96cc520d6c1c4856919b4c6d4640086a"); // TODO: Fix key
    ...
    // Convert JSON results to a string to be parsed later           
